...
// abstract class SocketCallBackListener {
//   socketCallBackListener(String action, bool isSuccess, dynamic data);
// }
        ...
        Row(
            ...
            children: <Widget>[
              ...
              FlatButton(
                  color: Colors.black12,
                  onPressed: () {
                    _firstUserClient.publish(['testafterSignal', 'Channel2'],
                        {'message': 'Hello World!'});
        ...
        Row(
            ...
            children: <Widget>[
              FlatButton(
                  color: Colors.black12,
                  onPressed: () {
                    _firstUserClient.history('testafterSignal', 1000).then((items) {
