...
import 'package:thcMobile/videocall/ApiClient.dart';
import 'package:thcMobile/videocall/RequestConfig.dart';
...
class Signaling {
  ...
  void muteMic(bool isMute) {
    if (_localStream != null) {
      //_FIX_IT
      _localStream.getVideoTracks()[0].setMicrophoneMute(isMute);
    }
  }
  ...
  Future<void> connect(BuildContext context) async {
    try {
      ...
      _socket.asBroadcastStream(onListen: (value){
        print("asdfgsfddfsdasdfg");
      });
      ...
      _createLocalPeerConnection().then((_) {
        _idJoinRoom = _sendJson(JsonConstants.joinRoom, {
          ...
          'secret': '2d6c828e-5c29-4072-a8ab-f72aea58d8e8',
