...
class AppointmentDetails extends StatefulWidget {
  AppointmentDetails(
      {Key key, this.title, this.appointment, @required this.isPrevious})
      : super(key: key);
  final String title;
...
class _AppointmentDetailsState extends State<AppointmentDetails> {
  ...
  void cancelAppointment() async {
    ...
    var response = await http.patch(url + "session-request/$id/", body: {
      'description': 'decline'
    }, headers: {
        ...
        builder: (ctx) {
          return Container(
            ...
            child: Column(
                ...
                children: <Widget>[
                  HeaderText(title: 'Manage appointent'),
                  SizedBox(height: 28),
                  AccountListItem(
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (_) => ScheduleAppointment(
                                    isSession: true,
                                    doctorId: widget.appointment.doctor != null
                                        ? widget.appointment.doctor.id
                                        : 0,
                                    doctorName: widget.appointment.doctor !=
                                            null
                ...
                children: <Widget>[
                      ...
                      widget.appointment.doctor != null
                          ? ClipRRect(
                              ...
                              child: Image.network(
                                  ...
                                  height: 50))
                          : Container(),
                      SizedBox(width: sizer(true, 12, context)),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        mainAxisSize: MainAxisSize.max,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          widget.appointment.doctor != null
                              ? Text(
                                  "Dr " + widget.appointment.doctor.user.name,
                                  style: TextStyle(
                                      color: Color(0xff071232),
                          ...
                          SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: widget.appointment.doctor != null
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Color(0xffDFE8FC), width: 1)),
                    child: Column(
                      children: <Widget>[
                        Padding(
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  widget.appointment.preferredTime != null
                                      ? Text(
                                ...
                                children: <Widget>[
                                  Text(
                                    widget.appointment.hospital != null &&
                                            widget.appointment.hospital.bio !=
                                                null
                                        ? widget.appointment.hospital.bio
                                        : '',
                                    style: TextStyle(
                                  ...
                                  Text(
                                    widget.appointment.hospital != null &&
                                            widget.appointment.hospital
                                                ...
                                                null
                                        ? widget
                                            .appointment.hospital.officeAddress
                                        : '',
                                    style: TextStyle(
                                      color: Color(0xff8E919C),
                  ...
                  SizedBox(height: 5),
                  widget.appointment.description != null
                      ? Text(
