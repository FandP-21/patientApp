...
import './components/priceBox.dart';
...
class _HospitalProfileState extends State<HospitalProfile> {
  ...
  Future<Null> hospitalBilling() async {
    ...
    response = await dio.get(url + "hospital-billing-r/${widget.hospital.id}/",
        options: Options(headers: {
          "Connection": 'keep-alive',
          "Authorization": "Bearer " + token
        }));
    responseX = await dio.get(url + "hospital-services/${widget.hospital.id}/",
        options: Options(headers: {
          "Connection": 'keep-alive',
          "Authorization": "Bearer " + token
        }));
  ...
  Future<Null> fetchCategories() async {
    ...
    response = await dio.get(
        url + "hospital-pricing-categories/${widget.hospital.id}/",
        options: Options(headers: {
          "Connection": 'keep-alive',
          "Authorization": "Bearer " + token
        }));
