...
import 'package:thcMobile/screens/dashboard/components/menuDropdown.dart';

class ScheduleAppointmentLab extends StatefulWidget {
  ScheduleAppointmentLab({Key key, this.title, @required this.hospital})
      : super(key: key);
  final String title;
  final Hospital hospital;

  @override
  _ScheduleAppointmentLabState createState() => _ScheduleAppointmentLabState();
}
                  ...
                  new SingleChildScrollView(
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 5),
                          Text(
                              'Schedule an appointment at ${widget.hospital.user.username} lab',
                              style: TextStyle(
